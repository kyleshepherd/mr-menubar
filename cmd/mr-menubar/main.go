...
import (
	...
	"github.com/kyleshepherd/mr-menubar/internal/config"
	"github.com/kyleshepherd/mr-menubar/internal/version"
)
...
func mrmenubarCmd() *cobra.Command {
	...
	pflags.StringVarP(&configPath, "config", "c", "", "path to configuration file (default is $HOME/.config/mr-menubar.toml)")
...
// mr-menubarRun is executed when the CLI executes
// the mr-menubar command
func mrmenubarRun(cmd *cobra.Command, _ []string) error {
	return cmd.Help()
}
